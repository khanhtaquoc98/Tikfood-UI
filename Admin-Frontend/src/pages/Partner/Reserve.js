...
export default class Reserve extends React.Component{
    ...
    onDeleteStore = (id) => {
        if(cookies.get('admin') != undefined){
            DeleteReserver(cookies.get('admin'),id).then(res => {
                if(res == null){
               ...
               <div className="main-content">
                <div className="container-fluid">
                    ...
                    <div className="col-12">
                        ...
                        <h4 className="mb-0 font-size-18">Danh sách đặt bàn - {this.state.Reserve ? this.state.Reserve.length + " đơn đặt bàn" : "0 đơn đặt bàn"}</h4>
                        <div className="page-title-right">
                            <ol className="breadcrumb m-0">
                            <li className="breadcrumb-item"><a>Home</a></li>
                            <li className="breadcrumb-item active">Danh sách đặt bàn</li>
                            </ol>
                        </div>
                        </div>
                    </div>
