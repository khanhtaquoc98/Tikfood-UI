...
export default class DetailUser extends React.Component{
    ...
    setModal1Visible(modal1Visible, update) {
        ...
        if(update == true){
            PutUser(cookies.get('partner'),User._id,
                ...
                <div className="main-content">
                 <div className="container-fluid">
                     ...
                     <div className="col-12">
                         ...
                         <h4 className="mb-0 font-size-18">Trang chủ</h4>
                     ...
                     <div className="col-xl-4">
                         ...
                         <div className="card-body pt-0">
                             ...
                             <div className="col-sm-4">
                                 ...
                                 <h5 className="font-size-15 text-truncate">{User.fullname == "Chưa cập nhật" ? User.email : User.fullname}</h5>
                                 {
                                     this.showEditActive()
                                 }
                             </div>
