    ...
    var r = {
      ...
      n = {
        networkDefs: {
          ...
          linkedin: {
            url:
              "http://www.linkedin.com/shareArticle?mini=true&url=|u|&title=|t|&summary=|d|&source=in1.com",
          },
          ...
          pinterest: {
            url:
              "http://pinterest.com/pin/create/button/?url=|u|&media=&description=|d|",
          },
...
(function (e, t) {
  ...
  function b(e) {
    return wt({}, e, { right: e.left + e.width, bottom: e.top + e.height });
  }
  function u(e) {
    var r = {};
    try {
  ...
  function x(e) {
    var a = e.nodeName;
    return (
      "BODY" !== a && "HTML" !== a && ("fixed" === t(e, "position") || x(r(e)))
    );
  }
  function w(e) {
    ...
    if ("viewport" === o) n = g(s, i);
      ...
      if ("HTML" === d.nodeName && !x(s)) {
        var m = h(e.ownerDocument),
          f = m.height,
          b = m.width;
        (n.top += c.top - c.marginTop),
          (n.bottom = f + c.top),
          (n.left += c.left - c.marginLeft),
          (n.right = b + c.left);
      } else n = c;
    }
    p = p || 0;
  ...
  function E(e, t, r, a, p) {
    ...
    var i = v(r, a, o, p),
      ...
      s = Object.keys(n)
        .map(function (e) {
          return wt({ key: e }, n[e], { area: k(n[e]) });
        })
        .sort(function (e, t) {
  ...
  function K(e, t, r, a) {
    ...
    if ("vh" === i || "vw" === i) {
      ...
      return (
        (l =
          "vh" === i
            ? Ze(document.documentElement.clientHeight, window.innerHeight || 0)
            : Ze(document.documentElement.clientWidth, window.innerWidth || 0)),
        (l / 100) * o
      );
    }
    return o;
  ...
  function be(e, t) {
    ...
    return (
      ...
      t.interactive && se(r, a),
      t.arrow && a.appendChild(ie(t.arrowType)),
      t.animateFill &&
        (a.appendChild(ne()), a.setAttribute("data-animatefill", "")),
      t.inertia && pe(a),
      re(p, t),
      a.appendChild(p),
      r.appendChild(a),
  ...
  function ye(e, t, r) {
    ...
    (e.style.zIndex = r.zIndex),
      ...
      t.content !== r.content && re(o, r),
      !t.animateFill && r.animateFill
        ? (p.appendChild(ne()), p.setAttribute("data-animatefill", ""))
        : t.animateFill &&
          !r.animateFill &&
          (p.removeChild(i), p.removeAttribute("data-animatefill")),
      !t.arrow && r.arrow
        ? p.appendChild(ie(r.arrowType))
        : t.arrow && !r.arrow && p.removeChild(n),
      t.arrow &&
        r.arrow &&
        t.arrowType !== r.arrowType &&
        p.replaceChild(ie(r.arrowType), n),
      !t.interactive && r.interactive
        ? se(e, p)
        : t.interactive && !r.interactive && le(e, p),
      !t.inertia && r.inertia ? pe(p) : t.inertia && !r.inertia && oe(p),
      t.theme !== r.theme &&
        (t.theme.split(" ").forEach(function (e) {
  ...
  function Pe() {
    Pt ||
      ((Pt = !0),
      it && document.body.classList.add("tippy-iOS"),
      window.performance && document.addEventListener("mousemove", De));
  }
  function De() {
    ...
    20 > e - Dt &&
      ...
      !it && document.body.classList.remove("tippy-iOS")),
      (Dt = e);
  }
  function Xe(e) {
    var t = e.target;
  ...
  function He() {
    document.addEventListener("click", Xe, !0),
      document.addEventListener("touchstart", Pe, At),
  ...
  function ze() {
    ...
    Object.keys(e).forEach(function (e) {
      if (!ke(t, e))
        throw new Error("[tippy]: `" + e + "` is not a valid option");
    });
  }
  function Fe(e, t) {
  ...
  function qe(e, t) {
    var r = me(Z(e, Ot.POPPER)),
      ...
      p = Ye(["right", "bottom"], r),
      o = {
        translate: { axis: Ue(t, "translate"), numbers: Ve(t, Nt.translate) },
        scale: { axis: Ue(t, "scale"), numbers: Ve(t, Nt.scale) },
      },
      i = t
        .replace(
          Nt.translate,
          "translate" +
            Fe(o.translate.axis, a) +
            "(" +
            _e("translate", o.translate.numbers, a, p) +
            ")"
        )
        .replace(
          Nt.scale,
  ...
  function je(e, t) {
    ...
    function a() {
      (X = new MutationObserver(function () {
        ...
        X.observe(U, { childList: !0, subtree: !0, characterData: !0 });
    }
    function p(e) {
      var t = (N = e),
        r = t.clientX,
      ...
      if (q.popperInstance) {
        var p = me(q.popper),
          ...
          l = i ? Ze(o, r) : r,
          d = n ? Ze(o, a) : a;
        i && l > o && (l = Ge(r, window.innerWidth - o)),
          n && d > o && (d = Ge(a, window.innerHeight - o));
    ...
    function o(e) {
      ...
      t &&
        !t._tippy &&
        (je(t, It({}, q.props, { target: "", showOnInit: !0 })), i(e));
    }
    function i(e) {
    ...
    function c(e) {
      ...
      r ||
        a ||
        (xe(me(q.popper), q.popper.getBoundingClientRect(), e, q.props) &&
          (l(), n()));
    }
    function m(e) {
      return y(e)
      ...
      return new Lt(
        ...
        It({ placement: q.props.placement }, e, {
          modifiers: It({}, e ? e.modifiers : {}, {
            ...
            offset: It({ offset: q.props.offset }, Ae(e, "offset")),
          }),
          onCreate: function () {
            (r.style[me(q.popper)] = we(q.props.distance, st.distance)),
              a && q.props.arrowTransform && qe(a, q.props.arrowTransform);
          },
          onUpdate: function () {
            var e = r.style;
            (e.top = ""),
              ...
              (e.left = ""),
              (e.right = ""),
              (e[me(q.popper)] = we(q.props.distance, st.distance)),
              a && q.props.arrowTransform && qe(a, q.props.arrowTransform);
          },
        })
      );
    ...
    function w() {
      ...
      (function e() {
        q.popperInstance && q.popperInstance.scheduleUpdate(),
          q.state.isMounted ? requestAnimationFrame(e) : de([q.popper], 0);
      })();
    }
    function v(e, t) {
      E(e, function () {
    ...
    function C(e, t) {
      ...
      q.reference.addEventListener(e, t, r),
        R.push({ eventType: e, handler: t, options: r });
    }
    function L() {
      q.props.touchHold &&
        !q.props.target &&
        (C("touchstart", d, At), C("touchend", m, At)),
        q.props.trigger
          .trim()
          .split(" ")
          .forEach(function (e) {
            "manual" === e ||
              (q.props.target
                ? "mouseenter" === e
                  ? (C("mouseover", h), C("mouseout", b))
                  : "focus" === e
                  ? (C("focusin", h), C("focusout", b))
                  : "click" === e
                  ? C(e, h)
                  : void 0
                : (C(e, d),
    ...
    function S() {
      ...
      (r.performance = ke(e, "performance") ? e.performance : t.performance),
        (q.props = r),
        (ke(e, "trigger") || ke(e, "touchHold")) && (O(), L()),
        ke(e, "interactiveDebounce") &&
          (l(), (F = Se(c, e.interactiveDebounce))),
        ye(q.popper, t, r),
        (q.popperChildren = ae(q.popper)),
        q.popperInstance &&
          lt.some(function (t) {
            return ke(e, t);
          }) &&
    ...
    function A() {
      var e =
        0 < arguments.length && void 0 !== arguments[0]
          ? arguments[0]
          : Le(q.props.duration, 0, st.duration[0]);
      return q.state.isDestroyed || !q.state.isEnabled || (Pt && !q.props.touch)
        ? void 0
                ...
                q.state.isVisible &&
                  ...
                  k(e, function () {
                    0 === q.props.updateDuration &&
                      ...
                      q.props.autoFocus &&
                        q.props.interactive &&
                        Ye(["focus", "click"], I.type) &&
                        Oe(q.popper),
                      q.props.aria &&
                        q.reference.setAttribute(
                          "aria-" + q.props.aria,
                          q.popper.id
                        ),
                      q.props.onShown(q),
    ...
    function Y() {
      var e =
        0 < arguments.length && void 0 !== arguments[0]
          ? arguments[0]
          : Le(q.props.duration, 1, st.duration[1]);
      q.state.isDestroyed ||
        !q.state.isEnabled ||
        !1 === q.props.onHide(q) ||
        (0 === q.props.updateDuration &&
        ...
        q.props.autoFocus &&
          ...
          !z &&
          Ye(["focus", "click"], I.type) &&
          ("focus" === I.type && (z = !0), Oe(q.reference)),
        v(e, function () {
          M || s(),
            q.props.aria && q.reference.removeAttribute("aria-" + q.props.aria),
            q.popperInstance.disableEventListeners(),
    ...
    function P(e) {
      q.state.isDestroyed ||
        (q.state.isMounted && Y(0),
        O(),
        q.reference.removeEventListener("click", r),
        delete q.reference._tippy,
        q.props.target &&
          e &&
          Q(q.reference.querySelectorAll(q.props.target)).forEach(function (e) {
    ...
    U.addEventListener("mouseenter", function (e) {
      ...
      U.addEventListener("mouseleave", function (e) {
        q.props.interactive &&
          ...
          xe(me(U), U.getBoundingClientRect(), e, q.props) &&
          n();
      });
    var V = ae(U),
      q = {
    ...
    return (
      ...
      D.showOnInit && i(),
      !D.a11y || D.target || We(e) || e.setAttribute("tabindex", "0"),
      (e._tippy = q),
      (U._tippy = q),
      q
    );
  ...
  for (
    var Ge = Math.min,
      ...
      rt = tt ? navigator : {},
      at = tt ? window : {},
      pt = ("MutationObserver" in at),
      ot = /MSIE |Trident\//.test(rt.userAgent),
      it = /iPhone|iPad|iPod/.test(rt.platform) && !at.MSStream,
      nt = ("ontouchstart" in at),
      st = {
        a11y: !0,
        allowHTML: !0,
        animateFill: !0,
      ...
      function t(r, a) {
        ...
        ut(this, t),
          ...
          (this.modifiers = Object.keys(this.options.modifiers)
            .map(function (e) {
              return wt({ name: e }, p.options.modifiers[e]);
            })
            .sort(function (e, t) {
      ...
      modifiers: {
        ...
        arrow: {
          ...
          fn: function (e, r) {
            ...
            var o = e.placement.split("-")[0],
              ...
              h = l ? "bottom" : "right",
              y = L(p)[d];
            s[h] - y < n[m] && (e.offsets.popper[m] -= n[m] - (s[h] - y)),
              s[m] + y > n[h] && (e.offsets.popper[m] += s[m] + y - n[h]),
            ...
            return (
              (v = Ze(Ge(n[d] - y, v), 0)),
              (e.arrowElement = p),
              (e.offsets.arrow = ((a = {}), xt(a, m, Qe(v)), xt(a, f, ""), a)),
              e
            );
          },
          element: "[x-arrow]",
            ...
            return (
              i.forEach(function (n, s) {
                ...
                var l = e.offsets.popper,
                  ...
                  c = Je,
                  m =
                    ("left" === a && c(l.right) > c(d.left)) ||
                    ("right" === a && c(l.left) < c(d.right)) ||
                    ("top" === a && c(l.bottom) > c(d.top)) ||
                    ("bottom" === a && c(l.top) < c(d.bottom)),
                  f = c(l.left) < c(r.left),
        ...
        computeStyle: {
          ...
          fn: function (e, t) {
            ...
            return (
              (e.attributes = wt({}, w, e.attributes)),
              (e.styles = wt({}, d, e.styles)),
              (e.arrowStyles = wt({}, e.offsets.arrow, e.arrowStyles)),
              e
            );
          },
          gpuAcceleration: !0,
        ...
        applyStyle: {
          ...
          fn: function (e) {
            return (
              ...
              _(e.instance.popper, e.attributes),
              e.arrowElement &&
          ...
          onLoad: function (e, t, r, a, p) {
            ...
            return (
              ...
              F(t, { position: r.positionFixed ? "fixed" : "absolute" }),
              r
            );
          },
  ...
  (Ke.version = et),
    ...
    (Ke.disableAnimations = function () {
      Ke.setDefaults({ duration: 0, updateDuration: 0, animateFill: !1 });
    }),
    (Ke.hideAllPoppers = ge),
    (Ke.useCapture = function () {});
  return (
    tt &&
      setTimeout(function () {
...
!(function (t, e) {
  ...
  (N || W) &&
    (R = function (t) {
      ...
      return (
        ...
        N && (i = s.lastIndex),
        (n = T.call(s, t)),
        N && n && (s.lastIndex = s.global ? n.index + n[0].length : i),
        W &&
          n &&
          n.length > 1 &&
          j.call(n[0], r, function () {
    ...
    G = v(function (t) {
      ...
      (g.inspectSource = function (t) {
        ...
        (t.exports = function (t, i, n, o) {
          ...
          s && (Y(n, "name") || $(n, "name", i)),
            t[i] !== n &&
              (s && (Y(n, e) || $(n, e, t[i] ? "" + t[i] : r.join(String(i)))),
              t === m
                ? (t[i] = n)
                : o
                ? t[i]
      ...
      return [
        ...
        function (t) {
          ...
          for (var c, u = [], f = 0; null !== (c = L(o, s)); ) {
            var d = String(c[0]);
            (u[f] = d),
              "" === d && (o.lastIndex = h(s, l(o.lastIndex), a)),
              f++;
          }
          return 0 === f ? null : u;
        },
  ...
  var ft,
    ...
    vt = {},
    yt = Object("z").propertyIsEnumerable(0)
      ? Object
      : function (t) {
    ...
    Ct = function (t, e, i) {
      t &&
        !Y((t = i ? t : t.prototype), Wt) &&
        Nt(t, Wt, { configurable: !0, value: e });
    },
    zt = {};
  ...
  var Dt = function (t, e, i) {
    ...
    qt = function (t, e, i, r, n, o, s) {
      ...
      if (
        (g &&
          (c = Pt(g.call(new t()))) !== Object.prototype &&
          c.next &&
          (Ct(c, h, !0), "function" != typeof c[Ft] && $(c, Ft, Ht)),
        f &&
          v &&
          "values" !== v.name &&
          ((d = !0),
    ...
    $t = qt(
      ...
      function () {
        ...
        return !t || i >= t.length
          ? ((this._t = void 0), pt(1))
          : pt(0, "keys" == e ? i : "values" == e ? t[i] : [i, t[i]]);
      },
      "values"
    );
  ...
  for (
    ...
    if (
      ie &&
      (ie[Xt] || $(ie, Xt, Gt), ie[Yt] || $(ie, Yt, Zt), (vt[Zt] = Gt), te)
    )
  ...
  qt(
    ...
    function () {
      ...
      return i >= e.length
        ? { value: void 0, done: !0 }
        : ((t = re(e, i)), (this._i += t.length), { value: t, done: !1 });
    }
  );
    ...
    "Array",
    {
      from: function (t) {
        var e,
          ...
          p = ce(a);
        if (
          (f && (h = U(h, u > 2 ? arguments[2] : void 0, 2)),
          null != p &&
            (c != Array ||
              void 0 === (s = p) ||
              (vt.Array !== s && se[oe] !== s)))
        )
          for (o = p.call(a), i = new c(); !(n = o.next()).done; d++)
            ae(i, d, f ? ne(o, h, [n.value, d], !0) : n.value);
        else
          for (i = new c((e = l(a.length))); e > d; d++)
  ...
  function je(t, e, i) {
    ...
    return (
      ...
      Re(i) &&
        ((u = !!i.leading),
        (o = (h = "maxWait" in i) ? Me(Ne(i.maxWait) || 0, e) : o),
  ...
  var We = function (t, e, i) {
      ...
      return (
        ...
        je(t, e, { leading: r, maxWait: e, trailing: n })
      );
    },
  ...
  var Qe = function (t, e, i) {
      ...
      return (
        ...
        Je(i) &&
          ((u = !!i.leading),
          (o = (h = "maxWait" in i) ? Ye(Ke(i.maxWait) || 0, e) : o),
          (f = "trailing" in i ? !!i.trailing : f)),
        (b.cancel = function () {
          void 0 !== a && clearTimeout(a), (c = 0), (r = l = n = a = void 0);
        }),
  ...
  var ai,
    ...
    fi = (ai = /[^.]+$/.exec((hi && hi.keys && hi.keys.IE_PROTO) || ""))
      ? "Symbol(src)_1." + ai
      : "",
    di = ci.toString,
  ...
  function qi(t) {
    ...
    if (
      ("border-box" === r.boxSizing &&
        (Math.round(a + o) !== e && (a -= Hi(r, "left", "right") + o),
        Math.round(l + s) !== i && (l -= Hi(r, "top", "bottom") + s)),
      !(function (t) {
  ...
  var $i =
    "undefined" != typeof SVGGraphicsElement
      ...
      : function (t) {
          return (
            t instanceof Pi(t).SVGElement && "function" == typeof t.getBBox
          );
        };
  function Xi(t) {
    return ji
        ...
        !(function (t, e) {
          ...
          (this.drag = function (e) {
            ...
            var s =
              ...
              r.contentEl[r.axis[r.draggedAxis].scrollSizeAttr];
            "x" === r.draggedAxis &&
              ((s =
                r.isRtl && t.getRtlHelpers().isRtlScrollbarInverted
                  ...
                  : s),
              (s =
                r.isRtl && t.getRtlHelpers().isRtlScrollingInverted ? -s : s)),
              (r.contentEl[r.axis[r.draggedAxis].scrollOffsetAttr] = s);
          }),
          ...
          (this.options = pe({}, t.defaultOptions, i)),
          (this.classNames = pe(
            {},
          ...
          },
          {
            ...
            value: function () {
              ...
              this.options.autoHide &&
                ...
                (this.resizeObserver = new Zi(this.recalculate)),
...
!(function (e) {
  (e.fn.jAutoCalc = function (t) {
    var s = {},
      ...
      a = function (e) {
        for (fields = new Array(), r = /{([^}]+)}/gi; null != (m = r.exec(e)); )
      ...
      o = function (t, r) {
        for (
          numValue = "",
            ...
            symLoc = -1,
            decPlaces = 0,
            sepOpts = s.decimalOpts.concat(s.thousandOpts),
            z = t.length - 1;
          z >= 0;
          z--
        )
          (ch = t.charAt(z)),
            -1 != e.inArray(ch, numOpts)
              ? (numValue = ch + numValue)
              : "" == dec && -1 != e.inArray(ch, s.decimalOpts)
              ? ((decLoc = z), (dec = ch), (numValue = "." + numValue))
              : "" == thou && -1 != e.inArray(ch, s.thousandOpts)
              ? (thou = ch)
              : "" != sym ||
                -1 != e.inArray(ch, sepOpts) ||
                (0 != z && z != t.length - 1) ||
                ((sym = ch), (symLoc = z));
        return (
          "" != dec &&
            ((decPlaces = t.length - decLoc - 1),
            symLoc > decLoc && decPlaces--),
          -1 != s.decimalPlaces && (decPlaces = s.decimalPlaces),
          2 == arguments.length &&
            ("" == r.dec && "" != dec && (r.dec = dec),
            ((-1 == r.decPlaces && -1 != decPlaces) ||
              (-1 != r.decPlaces &&
                -1 != decPlaces &&
                decPlaces < r.decPlaces)) &&
              (r.decPlaces = decPlaces),
            "" == r.thou && "" != thou && (r.thou = thou),
            "" == r.sym && "" != sym && ((r.sym = sym), (r.symLoc = symLoc))),
          s.emptyAsZero && "" == numValue && (numValue = "0"),
          numValue
        );
      },
      d = function (t, n, c, a) {
        ...
        for (func in u)
          for (
            f = u[func], r = new RegExp(f.rgx, "gi");
            null != (m = r.exec(t));

          )
            (v = f.exec(m[1], a, d)),
              (t = t.replace(new RegExp(f.rgx, "gi"), v));
        for (i = 0; i < n.length; i++) {
          if (
            ((field = n[i]),
            (fieldValue = e(l(field), a).val()),
            (numValue = o(fieldValue, d)),
            0 == numValue.length)
          )
        ...
        (t = t.replace(/ /g, "")),
          "" == d.dec && (d.dec = s.decimalOpts[0]),
          -1 == d.decPlaces && (d.decPlaces = 0),
          "" == d.thou && (d.thou = s.thousandOpts[0]),
          (resultValue = $(t)),
          null == resultValue
            ? (resultValue = "")
            : (resultValue = h(resultValue, d.decPlaces)),
          (resultValue = resultValue.replace(/\./g, "<c>")),
          (resultValue = resultValue.replace(/\,/g, "<t>")),
          (resultValue = resultValue.replace(/\<c\>/g, d.dec)),
          (resultValue = resultValue.replace(/\<t\>/g, d.thou)),
          d.symLoc > -1 &&
            (0 == d.symLoc
              ? (resultValue = d.sym + resultValue)
              : (resultValue += d.sym)),
          s.smartIntegers &&
            (resultValue = resultValue.replace(/[\,\.]0+$/, "")),
          e.isFunction(s.onShowResult) &&
            (resultValue = s.onShowResult.call(this, c, resultValue)),
          c.val(resultValue),
          s.chainFire && c.change();
      },
      h = function (e, t) {
        for (
          n = e.toFixed(t) + "",
      ...
      y = function (e) {
        ...
        if ("(" == e.string.substr(e.offset, 1)) {
          if ((e.offset++, (t = b(e)), ")" == e.string.substr(e.offset, 1)))
            return e.offset++, t;
        ...
        if ((r = /^[a-z_][a-z0-9_]*/i.exec(e.string.substr(e.offset)))) {
          ...
          throw (
            ((e.error = "Semantic error: unknown variable '" + s + "'"),
            "unknownVar")
          );
        }
        throw e.string.length == e.offset
          ? ((e.error = "Parsing error at end of string: value expected"),
            "valueMissing")
          : ((e.error = "Parsing error: unrecognized value"), "valueNotParsed");
      },
      V = function (e) {
        return -e;
      },
      P = function (e) {
        return "**" == e.string.substr(e.offset, 2)
          ...
          ? g[e.string.substr(e.offset++, 1)]
          : null;
      },
      b = function (e) {
        for (var t, r = [{ precedence: 0, assoc: "L" }], n = y(e); ; ) {
          for (
            t = P(e) || { precedence: 0, assoc: "L" };
            t.precedence < r[r.length - 1].precedence ||
            (t.precedence == r[r.length - 1].precedence && "L" == t.assoc);
      ...
      $ = function (e) {
        var t = { string: e, offset: 0 };
        try {
          var r = b(t);
          if (t.offset < t.string.length)
            throw (
              ((t.error = "Syntax error: junk found at offset " + t.offset),
              "trailingJunk")
            );
          return r;
        } catch (n) {
      ...
      L = function (t) {
        for (
          s = e.extend({}, e.fn.jAutoCalc.defaults), i = 0;
          i < t.length;
          i++
        )
          "object" == typeof t[i] && (s = e.extend(s, t[i]));
      ...
      j = {
        init: function () {
          return this.each(function () {
            ($ctx = e(this)),
              e("[" + s.attribute + "]:not([_jac])", $ctx).each(function () {
                if (
                  (($this = e(this)),
                  (eq = $this.attr(s.attribute)),
                  (fields = a(eq)),
                  0 != fields.length)
                ) {
                  ...
                  s.readOnlyResults && $this.attr("readonly", !0),
                    $this.attr("_jac", "_jac"),
                    s.initFire && e(l(fields[0]), $ctx).change();
                }
              });
          });
        },
        destroy: function () {
          return this.each(function () {
            ($ctx = e(this)),
              e("[" + s.attribute + "][_jac]", $ctx).each(function () {
                if (
                  (($this = e(this)),
                  (eq = $this.attr(s.attribute)),
                  (fields = a(eq)),
                  ...
                  for (field = "", i = 0; i < fields.length; i++)
                    (field = fields[i]), e(l(field), $ctx).unbind(".jautocalc");
                  s.readOnlyResults && $this.removeAttr("readonly"),
