...
export default class ResetPasswithEmail extends React.Component{
    ...
    handleSent = () => {
        if(this.state.email != undefined && checkMail(this.state.email))
        {
            ...
            axios.post("http://localhost:8080/sendmailresetpassword",{"email" : this.state.email}).then(res => {
              ...
              <Head>
                ...
                <div className="content">
                    ...
                    <div className="container">
                        ...
                        <div >
                            <h4 style={{fontSize: "3rem", color: "#fff"}}>Quên mật khẩu?</h4>
                        </div>
                        ...
                        {this.state.isSucces && <p style={{fontWeight: "700"}}>Bạn vui lòng vào email của bạn để được đổi mật khẩu mới!</p>}
                        <div className="farme">
