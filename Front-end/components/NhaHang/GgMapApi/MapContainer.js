 ...
 class MapContainer extends React.Component{
  ...
  componentDidMount(){
    ...
    if(ListRestaurants != undefined){
      this.setState({LatInfoWindow: ListRestaurants[0].address.longtitude*1 > ListRestaurants[0].address.latitude*1 ? ListRestaurants[0].address.latitude*1 : ListRestaurants[0].address.longtitude*1,
                    LngInfoWindow: ListRestaurants[0].address.longtitude*1 > ListRestaurants[0].address.latitude*1 ? ListRestaurants[0].address.longtitude*1 : ListRestaurants[0].address.latitude*1})
  ...
  componentDidUpdate(prevProps, prevState){
    if(this.props.ListRestaurants != prevProps.ListRestaurants ){
     ...
     {
      let lat =  this.props.ListRestaurants[0].address.longtitude*1 > this.props.ListRestaurants[0].address.latitude*1 ? this.props.ListRestaurants[0].address.latitude*1 : this.props.ListRestaurants[0].address.longtitude*1
      let long  = this.props.ListRestaurants[0].address.longtitude*1 > this.props.ListRestaurants[0].address.latitude*1 ? this.props.ListRestaurants[0].address.longtitude*1 : this.props.ListRestaurants[0].address.latitude*1
                 ...
                 if(ListRestaurants){
                  return(
                    ListRestaurants.map((item, index) =>{
                      let long = item.address.longtitude*1 > item.address.latitude*1 ? item.address.longtitude*1 : item.address.latitude*1;
                      let lat = item.address.longtitude*1 > item.address.latitude*1 ? item.address.latitude*1 : item.address.longtitude*1;
